...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=12,  decimal_places=2, default=0.00, null=True,verbose_name='Sale Price')
    regular_price = models.DecimalField(max_digits=12,  decimal_places=2, default=0.00, null=True,verbose_name='Regural Price')
    ...
    status = models.CharField(choices=STATUS, max_length=30, default='Published')
    ...
    sku = ShortUUIDField(unique = True, length=5, max_length = 50, prefix = "SKU", alphabet = '123456890')
...
class Gallery(models.Model):
    ...
    gallery_id = ShortUUIDField(length = 6, max_length = 20, alphabet='1234567890')
...
class Order(models.Model):
    ...
    saved = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, null=True, blank=True, help_text='Amount your have saved')
...
class OrderItem(models.Model):
    ...
    inital_total = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, help_text="The original Amount before")
    saved = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, null=True, blank=True,  help_text="Amount Saved")
    coupons = models.ManyToManyField(Coupon, blank=True)
