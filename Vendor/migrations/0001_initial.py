# Generated by Django 4.2 on 2024-11-22 08:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Payout', to='Store.orderitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(blank=True, choices=[('BANK_TRANSFER', 'Bank Transfer'), ('UPI', 'UPI (Unified Payments Interface)'), ('PAYTM', 'Paytm Wallet'), ('GOOGLE_PAY', 'Google Pay'), ('PHONEPE', 'PhonePe'), ('AMAZON_PAY', 'Amazon Pay'), ('CASH', 'Cash')], max_length=50, null=True)),
                ('bank_name', models.CharField(max_length=255)),
                ('account_number', models.CharField(max_length=50)),
                ('account_name', models.CharField(max_length=100)),
                ('bank_code', models.CharField(blank=True, max_length=25, null=True)),
                ('paypal_address', models.EmailField(blank=True, max_length=225, null=True)),
                ('upi_adress', models.CharField(blank=True, max_length=100, null=True)),
