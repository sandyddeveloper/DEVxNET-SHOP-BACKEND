...
class Payout(models.Model):
    ...
    item = models.ForeignKey('Store.OrderItem', on_delete=models.SET_NULL, null=True, related_name="Payout")
...
class BankAccount(models.Model):
    ...
    paypal_address = models.EmailField(max_length=225, null=True, blank=True)
    upi_adress = models.CharField(max_length=100, null=True, blank=True)
